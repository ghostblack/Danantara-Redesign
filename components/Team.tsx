...
const TEAM_DATA = [
  {
    ...
    imageHover: "https://ik.imagekit.io/gambarid/Danantara/WhatsApp%20Image%202025-12-01%20at%2019.47.51%20(1).jpeg"
  },
  {
    name: "Pandu Sjahrir",
    ...
    imageHover: "https://ik.imagekit.io/gambarid/Danantara/s2.png"
  },
  {
    name: "Dony Oskaria",
    ...
    imageHover: "https://ik.imagekit.io/gambarid/Danantara/s3.png"
  }
];
    ...
    <section id="team" ref={sectionRef} className="w-full bg-white px-6 md:px-12 lg:px-20 py-24 md:py-32 max-w-[1920px] mx-auto overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 lg:gap-10">
        {TEAM_DATA.map((member, index) => (
          ...
          >
            {/* Image Container */}
            <div className="relative w-full aspect-[432/500] rounded-[2rem] overflow-hidden bg-gray-100 transition-transform duration-500 ease-out group-hover:scale-[1.01]">
              
              {/* Default Image */}
              <img 
                src={member.image}
                alt={member.name}
                className="absolute inset-0 w-full h-full object-cover object-top filter transition-opacity duration-500 ease-in-out opacity-100 group-hover:opacity-0" 
              />
              ...
              <img 
                ...
                className="absolute inset-0 w-full h-full object-cover object-top filter transition-opacity duration-500 ease-in-out opacity-0 group-hover:opacity-100" 
              />
